...
_lr_productions = [
  ...
  ('codigo -> algoritmo','codigo',1,'p_codigo','sintactico_yacc.py',32),
  ('codigo -> algoritmo codigo','codigo',2,'p_codigo','sintactico_yacc.py',33),
  ('algoritmo -> asignacion','algoritmo',1,'p_algoritmo','sintactico_yacc.py',36),
  ('algoritmo -> sentenciaWHILE','algoritmo',1,'p_algoritmo','sintactico_yacc.py',37),
  ('algoritmo -> sentenciaFOR','algoritmo',1,'p_algoritmo','sintactico_yacc.py',38),
  ('algoritmo -> puts','algoritmo',1,'p_algoritmo','sintactico_yacc.py',39),
  ('algoritmo -> unless','algoritmo',1,'p_algoritmo','sintactico_yacc.py',40),
  ('algoritmo -> comentarios','algoritmo',1,'p_algoritmo','sintactico_yacc.py',41),
  ('algoritmo -> sentenciaIf','algoritmo',1,'p_algoritmo','sintactico_yacc.py',42),
  ('unless -> UNLESS comparacion codigo END','unless',4,'p_unless','sintactico_yacc.py',48),
  ('sentenciaFOR -> FOR variables IN range DO codigo END','sentenciaFOR',7,'p_sentenciaFor','sintactico_yacc.py',51),
  ('range -> ENTERO RANGO ENTERO','range',3,'p_range','sintactico_yacc.py',55),
  ('puts -> PUTS CADENA','puts',2,'p_puts','sintactico_yacc.py',59),
  ('sentenciaWHILE -> WHILE comparacion DO codigo END','sentenciaWHILE',5,'p_sentenciaWhile','sintactico_yacc.py',64),
  ('asignacion -> variables IGUAL expresion','asignacion',3,'p_asignacion','sintactico_yacc.py',68),
  ('expresion -> valor','expresion',1,'p_expresion','sintactico_yacc.py',71),
  ('expresion -> valor operadorMat expresion','expresion',3,'p_expresion_aritmetica','sintactico_yacc.py',76),
  ('expresion -> PIZQ valor operadorMat expresion PDER','expresion',5,'p_expresion_aritmetica','sintactico_yacc.py',77),
  ('comparacion -> expresion operadorComp expresion','comparacion',3,'p_comparacion','sintactico_yacc.py',83),
  ('comparacion -> PIZQ expresion PDER operadorComp expresion','comparacion',5,'p_comparacion','sintactico_yacc.py',84),
  ('operadorMat -> MAS','operadorMat',1,'p_operadorMat','sintactico_yacc.py',89),
  ('operadorMat -> RESTA','operadorMat',1,'p_operadorMat','sintactico_yacc.py',90),
  ('operadorMat -> PROD','operadorMat',1,'p_operadorMat','sintactico_yacc.py',91),
  ('operadorMat -> DIVISION','operadorMat',1,'p_operadorMat','sintactico_yacc.py',92),
  ('operadorMat -> POTENCIA','operadorMat',1,'p_operadorMat','sintactico_yacc.py',93),
  ('operadorComp -> MAYOR','operadorComp',1,'p_operadorComp','sintactico_yacc.py',96),
  ('operadorComp -> MENOR','operadorComp',1,'p_operadorComp','sintactico_yacc.py',97),
  ('operadorComp -> COMP_IGUAL','operadorComp',1,'p_operadorComp','sintactico_yacc.py',98),
  ('operadorComp -> DIFERENTE','operadorComp',1,'p_operadorComp','sintactico_yacc.py',99),
  ('valor -> ENTERO','valor',1,'p_valor','sintactico_yacc.py',104),
  ('valor -> variables','valor',1,'p_valor','sintactico_yacc.py',105),
  ('valor -> CADENA','valor',1,'p_valor','sintactico_yacc.py',106),
  ('valor -> HASH','valor',1,'p_valor','sintactico_yacc.py',107),
  ('valor -> ARRAY','valor',1,'p_valor','sintactico_yacc.py',108),
  ('variables -> VARIABLE_LOCAL','variables',1,'p_variables','sintactico_yacc.py',113),
  ('variables -> VARIABLE_GLOBAL','variables',1,'p_variables','sintactico_yacc.py',114),
  ('variables -> VARIABLE_OBJETO','variables',1,'p_variables','sintactico_yacc.py',115),
  ('variables -> VARIABLE_CLASE','variables',1,'p_variables','sintactico_yacc.py',116),
  ('variables -> CONSTANTE','variables',1,'p_variables','sintactico_yacc.py',117),
  ('sentenciaIf -> IF comparacion codigo END','sentenciaIf',4,'p_sentenciaIf','sintactico_yacc.py',120),
  ('comentarios -> COMENTARIOL','comentarios',1,'p_comentarios','sintactico_yacc.py',123),
]
